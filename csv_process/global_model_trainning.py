...
def load_and_prepare_data(spark, hdfs_path, feature_columns, label_column="Ms", pca_k=5):
    """
    ...
    参数:
        ...
        label_column (str): 目标标签列的名称，默认为"Ms"。
        pca_k (int): PCA的主成分数量，默认为5。

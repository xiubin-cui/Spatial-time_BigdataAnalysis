...
#
# # 从HDFS读取处理后的数据
# hdfs_path_processed = "hdfs://hadoop101:9000/user/lhr/big_data/processed_全球地震台网地震目录_2_1_normalized_MinMaxScaler.csv"
...
#     return rmse, accuracy
# # # 线性回归
# # lr = LinearRegression(featuresCol="pca_features", labelCol="Ms", regParam=0.1, elasticNetParam=0.5)
...
# #
# # # 决策树回归
# # dt = DecisionTreeRegressor(featuresCol="pca_features", labelCol="Ms", maxDepth=10, minInstancesPerNode=2)
